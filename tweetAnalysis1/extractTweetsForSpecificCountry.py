...
for line in open('filteredGeolocatedTweets', 'r'):
        ...
        for feature in region:
            if shape(feature['geometry']).contains(point):
                filename1="tweetsByCountriesCoordinates/extractedTweetsFrom"+feature['properties']['NAME']+".txt"
                filename2="tweetsByCountriesFull/extractedTweetsFrom"+feature['properties']['NAME']+".txt"
                #print filename1
